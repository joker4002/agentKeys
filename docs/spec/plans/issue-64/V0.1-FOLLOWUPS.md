...
## Phase A.2 P2/P3 (US-020/021/022 codex rounds)

Round 1 found 0 P0, 1 P1, 2 P2, 3 P3. P1 + Vector-10 P2 + Vector-13 P3 +
Vector-14 P3 closed in this iteration (commits below); remaining items
roll forward.
...
| PA2-R2-F3 | Google JWK filtering still accepts missing/empty `kty`; fail closed on `kty == "RSA"` only | Phase D auth hardening |
